...
- Field logs / bitacoras: `/biometrias`, `/control-fauna-nociva`, `/alimentacion`, `/recepcion_insumos`, `/control-visitas`, `/banos`, `/parametros`, `/medicamentos`, `/recambios`, `/inventario`
