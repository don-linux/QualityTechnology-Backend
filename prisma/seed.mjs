...
const MODULOS = [
  ...
  ["Infraestructura Física", "/infraestructura-fisica", true],
  ...
  ["Inventario Alevines", "/inventario-alevines", true],
  ...
  ["Tipos de infraestructura física", "/tipos-infraestructura-fisica", true],
