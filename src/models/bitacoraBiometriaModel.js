...
class BitacoraBiometriaModel {
    ...
    static async create(data) {
      ...
      `,
            [
                fd_fecha, fn_peso_total_gramos, fn_organismos_muestreados, fn_peso_promedio,
                fc_observaciones, fc_encargado, fi_instalacion_id || null, fi_lote_id || null,
    ...
    static async update(id, data) {
      ...
      UPDATE biometrias SET
        ...
        fi_instalacion_id = $7, fi_lote_id = $8, tipo = $9, fi_usuario_id = $10,
    ...
    static async getInfoByInstalacion(instalacionId) {
        ...
        if (!tabla || !campoFecha) return { tipo };
      ...
      `,
        ...
        if (q.rowCount === 0) return { tipo, fi_lote_id: null };
